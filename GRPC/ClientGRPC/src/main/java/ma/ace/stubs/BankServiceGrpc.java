...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.ace.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = ma.ace.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest, ma.ace.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.ace.stubs.Bank.ConvertCurrencyRequest, ma.ace.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.ace.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.ace.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod() {
    io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest, ma.ace.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest, ma.ace.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest,
      ma.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<ma.ace.stubs.Bank.ConvertCurrencyRequest, ma.ace.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(ma.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getStream(ma.ace.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public ma.ace.stubs.Bank.ConvertCurrencyResponse convert(ma.ace.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ma.ace.stubs.Bank.ConvertCurrencyResponse> getStream(
            Bank.ConvertCurrencyRequest request, StreamObserver<Bank.ConvertCurrencyResponse> serverStreamingRpcCompleted) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.ace.stubs.Bank.ConvertCurrencyResponse> convert(
        ma.ace.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.ace.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_STREAM:
          serviceImpl.getStream((ma.ace.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.ace.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.ace.stubs.Bank.getDescriptor();
    }
